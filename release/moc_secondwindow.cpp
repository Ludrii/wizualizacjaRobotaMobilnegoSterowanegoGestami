/****************************************************************************
** Meta object code from reading C++ file 'secondwindow.hh'
**
...
#error "The header file 'secondwindow.hh' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 29, 8), // "makePlot"
QT_MOC_LITERAL(4, 38, 16) // "realtimeDataSlot"

    },
    "SecondWindow\0openSerialPort\0\0makePlot\0"
    "realtimeDataSlot"
};
